...
namespace MeuCrudCsharp.Features.MercadoPago.Subscriptions.Application.Services
{
    public class SubscriptionService : ISubscriptionService
    {
        ...
        public async Task<(IEnumerable<AdminSubscriptionListDto> Items, long TotalCount)> GetPaginatedSubscriptionsAsync(
            int page, 
            int pageSize, 
        ...
        {
            var (items, totalCount) = await _subscriptionRepository.GetPaginatedSubscriptionsAsync(page, pageSize, statusFilter, searchTerm);
            ...
            var dtos = items.Select(s => new AdminSubscriptionListDto(
                ...
                NextBillingDate: s.CurrentPeriodEndDate
            ));
